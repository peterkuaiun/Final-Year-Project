...
size = 18900
file_list = ['n=7000d=6', 'n=7000d=8', 'n=7000d=10', 'n=7000d=12', 'n=7000d=15']
...
def Find_AllHolesNodes(all_holes,all_nodes,img = " ",color = (0,200,200),thickness = 3,label = False,sf = False):
    ...
    with open(r'D:\result data\dataset\Uniform\node id\\' + fname + '.txt','w') as f:
        for i in range (0,int(len(all_holes))):  
...
#fpath = (r'D:\data_600s\result\Sparse\FR\\'+ name + '\\graph')
for fname in file_list:
    ...
    print (fname)
    fpath = (r'D:\data_600s\dataset\Uniform\\' + fname)
    #The size of Hole
    all_nodes,all_edges = Read_data(fpath) #Read data
    #Add all the edges    
    ...
    cv2.imwrite(r'D:\result data\dataset\Uniform\\'+ fname + out_format, results_img)
