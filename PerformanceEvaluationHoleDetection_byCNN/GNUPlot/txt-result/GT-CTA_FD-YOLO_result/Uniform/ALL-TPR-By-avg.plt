...
set output "ALL-Uniform-TPR-By-avg.png"
...
plot\
"DH-TPR-By-avg.txt"		w lp ls 1 title 'DH', \
"FA2-TPR-By-avg.txt"		w lp ls 2 title 'FA2', \
"KK-W-TPR-By-avg.txt"		w lp ls 9 title 'KK-MS-DS', \
"FDGE-TPR-By-avg.txt"		w lp ls 3 title 'FDGE', \
"FRR-TPR-By-avg.txt"		w lp ls 4 title 'FRR', \
"FR-TPR-By-avg.txt"		w lp ls 5 title 'FR', \
"FRU-TPR-By-avg.txt"		w lp ls 6 title 'FRU', \
"JIGGLE-TPR-By-avg.txt"		w lp ls 7 title 'JIGGLE', \
"KK-TPR-By-avg.txt"		w lp ls 8 title 'KK', \
"LINLOG-TPR-By-avg.txt"		w lp ls 10 title 'LINLOG'
