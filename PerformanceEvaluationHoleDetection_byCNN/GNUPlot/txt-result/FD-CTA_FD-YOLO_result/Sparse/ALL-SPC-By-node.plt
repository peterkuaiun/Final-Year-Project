...
set output "ALL-Sparse-SPC-By-node.png"
...
plot\
"DH-SPC-By-node.txt"			w lp ls 1 title 'DH', \
"FA2-SPC-By-node.txt"		w lp ls 2 title 'FA2', \
"KK-W-SPC-By-node.txt"		w lp ls 9 title 'KK-MS-DS', \
"FDGE-SPC-By-node.txt"		w lp ls 3 title 'FDGE', \
"FRR-SPC-By-node.txt"		w lp ls 4 title 'FRR', \
"FR-SPC-By-node.txt"			w lp ls 5 title 'FR', \
"FRU-SPC-By-node.txt"		w lp ls 6 title 'FRU', \
"JIGGLE-SPC-By-node.txt"		w lp ls 7 title 'JIGGLE', \
"KK-SPC-By-node.txt"			w lp ls 8 title 'KK', \
"LINLOG-SPC-By-node.txt"	w lp ls 10 title 'LINLOG'
