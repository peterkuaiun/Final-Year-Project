...
Readme:
genrate hole training Image by Feature Transformation
...
def gen_img(fname,count_t,s = ""): 
    print('[INFO] Feature Transformation')
...
####Feature Transformation
        ...
        with open(name_0+".txt","w") as f:
            f.write("%d %f %f %f %f" %(0,o_x,o_y,o_w,o_h))    
####Feature Transformation

    print ("[DONE] %s Feature Transformation DONE.\n"%os.path.basename(fname))
    of.close()
